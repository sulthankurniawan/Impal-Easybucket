	...
	<body>	
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<a href=""><h3 class="breadcrumb-header">Customer's order</h3></a>
					</div>
				</div>	
				<!-- /row -->
			</div>
		...
		<div class="col-md-5 order-details" style="margin-left:60px;">
            ...
            <div class="order-summary">
            	...
            	<a href="#" class="primary-btn order-submit">Done</a>
        	</div>
		<!-- /Order Details -->
		...
		<!-- /Order Details -->
		<script>
				var element = document.getElementById("listOrder");
